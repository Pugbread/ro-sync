...
- --source and --source-file run through a temporary ModuleScript under CoreGui, matching the command-line style environment expected by Photobooth bindings instead of a custom loadstring sandbox.
